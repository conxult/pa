...
public abstract class CxPaBaseJavaMigration
    ...
    protected CreateTableMigrationTask createHistTable(Class tableClass) {
        String historyClassName = tableClass.getName() + "Hist";
        try {
            tableClass = Class.forName(historyClassName);
        } catch (ClassNotFoundException classNotFoundException) {
            System.err.println("Could not load history class: " + historyClassName);
        }
        return new CreateTableMigrationTask(this, tableClass);
    }
